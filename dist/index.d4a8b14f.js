const hamburgerBtn = document.querySelector("#hamburgerBtn"), primaryNavigation = document.querySelector("#primaryNavigation"), carouselContainer = document.querySelector("#carouselContainer");
const testimonials = [
    {
        name: "Anisha Li",
